            ...
            BindingPoint bindingPoint, IConfiguration config, BinderOptions options)
        {
            ...
            if (config != null && config.GetChildren().Any())
            {
                ...
                if (bindingPoint.Value is null)
                {
                    ...
                    // We've already set the value fore any collection interface type we know about.
                    // This will throwing for any public settable property with an unknown interface type including collections.
